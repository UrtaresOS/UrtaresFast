...
@echo off
echo UrtaresFast
title UrtaresFast by UrtaresOS
dir /s x1.reg
call x1.reg
...
echo UrtaresFast Tarafindan Temizlendi!> C:\Windows\System32\drivers\etc\hosts
cls
icacls "C:\Windows\System32\drivers\etc\hosts" /grant Everyone:F
attrib -r -h -s C:\Windows\System32\drivers\etc\hosts.BAK
echo UrtaresFast Tarafindan Temizlendi!> C:\Windows\System32\drivers\etc\hosts.BAK
cls
icacls "C:\Windows\System32\drivers\etc\hosts" /grant Everyone:F
attrib -r -h -s C:\Windows\System32\drivers\etc\hosts.BAK
echo UrtaresFast Tarafindan Temizlendi!> C:\Windows\System32\drivers\etc\hosts.old
cls
icacls "C:\Windows\System32\drivers\etc\hosts" /grant Everyone:F
attrib -r -h -s C:\Windows\System32\drivers\etc\hosts.txt
echo UrtaresFast Tarafindan Temizlendi!> C:\Windows\System32\drivers\etc\hosts.txt
cls
del hosts.txt
del hosts.BAK
del HOSTS.BAK
